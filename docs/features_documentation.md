...
| **PICASSO-Regime-Flags** (`is_picasso_active`, `is_picasso_regime`) | Abbildung zweier Regime-Anker: struktureller Schnitt im Datensatz (`2022-06-22 22:00 UTC`) und aktive PICASSO-Marktphase (`ab Juli 2024`). | Ermöglicht dem Modell die Trennung zwischen Übergangsregime und voll gekoppelter europäischer Preissetzungslogik.          |
