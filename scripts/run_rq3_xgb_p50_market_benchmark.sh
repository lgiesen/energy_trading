...
SPLIT="${SPLIT:-test}"
MODEL="${MODEL:-xgb}"
QUANTILE_PAIR="${QUANTILE_PAIR:-p50-p50}"
EXPECTED_BEST_MODEL="${EXPECTED_BEST_MODEL:-XGB}"
EXPECTED_BEST_QUANTILE="${EXPECTED_BEST_QUANTILE:-p50}"
...
RUN_NAME="${RUN_NAME:-rq3_xgb_p50_market_benchmark}"
RUN_ROOT="${RUN_ROOT:-artifacts/simulation_runs/${RUN_NAME}_${RUN_TS}}"
